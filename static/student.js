...
async function loadBookmarks(){
    ...
    try{
        ...
        box.innerHTML=items.length?items.map(x=>{
            ...
            const openBtn=x.url?`<a class="btn btn-outline" target="_blank" rel="noopener" href="${escapeHtml(x.url)}">Open</a>`:'';
...
function renderStudentPreview(){
    ...
    banner.innerHTML='<strong>ADMIN PREVIEW</strong> — Full Student Dashboard · Read-only view <span>Student actions that change data are disabled</span> <a href="/admin">Return to Admin</a>';
    document.body.prepend(banner);

    const name=document.getElementById('studentName');
    if(name) name.textContent='Admin — Student View';
    const greeting=document.getElementById('greetingName');
    if(greeting) greeting.textContent='Admin — Student View';
    const identity=document.getElementById('chatUserName');
    if(identity) identity.value='Admin Preview';

    const stats=document.getElementById('learningStats');
    if(stats) stats.innerHTML=[
        ['📈','78%','Average'],['🗓️','86%','Attendance'],['📝','4','Completed Exams'],['📚','3','Active Courses']
    ].map(([icon,value,label])=>`<div class="stat-card"><div style="font-size:1.2em">${icon}</div><strong>${value}</strong><span>${label}</span></div>`).join('');
    const progress=document.getElementById('progressGrade');
    if(progress) progress.textContent='Grade 8 · Read-only administrator preview';
    const next=document.getElementById('learningNext');
    if(next) next.innerHTML='<div class="card" style="margin-top:12px"><h4 style="margin-top:0">🎯 Recommended learning</h4><div class="list-row"><strong>Algebra practice</strong><span class="badge badge-free">Recommended</span></div><div class="list-row"><strong>Science revision</strong><span class="badge badge-free">Recommended</span></div><div class="list-row"><strong>Upcoming live class</strong><span class="badge badge-free">This week</span></div></div>';

    const setHtml=(id,html)=>{const el=document.getElementById(id);if(el)el.innerHTML=html;};
    setHtml('liveStreamContainer','<div class="list-row"><div><strong>🔴 BMT Global Live</strong><div class="subtitle">Admin preview of the student live-stream area.</div></div><span class="badge badge-free">Preview</span></div>');
    setHtml('booksContainer','<div class="item-row"><div class="item-content"><strong>📘 Mathematics — Grade 8</strong><div class="subtitle">Student textbook · Algebra, geometry and number skills</div></div><div class="item-actions"><span class="badge badge-free">Available</span></div></div><div class="item-row"><div class="item-content"><strong>📗 General Science — Grade 8</strong><div class="subtitle">Student textbook · Biology, chemistry and physics</div></div><div class="item-actions"><span class="badge badge-free">Available</span></div></div>');
    setHtml('studentVideosContainer','<div class="video-card item-row"><div class="item-content"><strong>🎥 Algebra Lesson 1</strong><div class="subtitle">Grade 8 · Mathematics</div></div><span class="badge badge-free">Video</span></div><div class="video-card item-row"><div class="item-content"><strong>🎥 Introduction to Biology</strong><div class="subtitle">Grade 8 · Science</div></div><span class="badge badge-free">Video</span></div>');
    setHtml('playlistContainer','<div class="item-row"><div class="item-content"><strong>📋 My Learning Playlist</strong><div class="subtitle">2 saved learning videos are shown here in the student experience.</div></div><span class="badge badge-free">Preview</span></div>');
    setHtml('downloadedVideosContainer','<div class="item-row"><div class="item-content"><strong>📥 Downloaded learning videos</strong><div class="subtitle">The student dashboard supports offline video management here.</div></div><span class="badge badge-free">Preview</span></div>');
    setHtml('studentAssignmentList','<div class="list-row"><div><strong>Algebra Worksheet</strong><div class="subtitle">Grade 8 · Due this week</div></div><span class="badge badge-free">Assignment</span></div><div class="list-row"><div><strong>Science Lab Reflection</strong><div class="subtitle">Grade 8 · Submitted for review</div></div><span class="badge badge-free">Assignment</span></div>');
    setHtml('quizContainer','<div class="item-row"><div class="item-content"><strong>✍️ Mathematics Practice Quiz</strong><div class="subtitle">10 questions · Grade 8 · Practice mode</div></div><span class="badge badge-free">Quiz</span></div><div class="item-row"><div class="item-content"><strong>✍️ Science Review Quiz</strong><div class="subtitle">10 questions · Grade 8 · Practice mode</div></div><span class="badge badge-free">Quiz</span></div>');
    setHtml('examsContainer','<div class="item-row"><div class="item-content"><strong>📄 Grade 8 Mid-Term Examination</strong><div class="subtitle">Secure exam area · 60 minutes</div></div><span class="badge badge-pending">Preview</span></div>');
    setHtml('examHistoryContainer','<div class="item-row"><div class="item-content"><strong>Grade 8 Mathematics</strong><div class="subtitle">Score 82% · Completed</div></div><span class="badge badge-free">82%</span></div>');
    setHtml('liveClassList','<div class="list-row"><div><strong>📅 Mathematics Live Class</strong><div class="subtitle">Grade 8 · Wednesday · Teacher-led</div></div><span class="badge badge-free">Upcoming</span></div><div class="list-row"><div><strong>📅 Science Q&A</strong><div class="subtitle">Grade 8 · Friday · Teacher-led</div></div><span class="badge badge-free">Upcoming</span></div>');
    setHtml('examArchiveList','<div class="item-row"><div class="item-content"><strong>🏛️ Grade 8 National Examination Archive</strong><div class="subtitle">Past papers, subjects, years and archive search.</div></div><span class="badge badge-free">Archive</span></div><div class="item-row"><div class="item-content"><strong>🏛️ Grade 12 National Examination Archive</strong><div class="subtitle">Stream-aware national exam resources.</div></div><span class="badge badge-free">Archive</span></div>');
    setHtml('libraryList','<div class="item-row"><div class="item-content"><strong>📘 Mathematics Student Textbook</strong><div class="subtitle">Grade 8 · Student Textbooks</div></div><span class="badge badge-free">Library</span></div><div class="item-row"><div class="item-content"><strong>📙 Teacher Guide & Reference Material</strong><div class="subtitle">Reference · General development</div></div><span class="badge badge-free">Library</span></div>');
    setHtml('chatMessagesContainer','<div class="chat-message"><strong>Teacher:</strong> Welcome to the BMT community.</div><div class="chat-message"><strong>Student:</strong> Thank you! I am ready to learn.</div><div class="chat-message"><strong>Admin:</strong> Student community, support and teacher Q&A are available here.</div>');
    setHtml('studentSupportTickets','<div class="item-row"><div class="item-content"><strong>Example: Academic support request</strong><div class="subtitle">Status: open · Read-only preview</div></div><span class="badge badge-pending">Support</span></div>');
    setHtml('paymentHistory','<div class="item-row"><div class="item-content"><strong>Premium subscription history</strong><div class="subtitle">Payment history and premium status are shown in this student area.</div></div><span class="badge badge-free">Preview</span></div>');

    const profileName=document.getElementById('profileName'); if(profileName) profileName.textContent='Admin Student Preview';
    const navButtons=document.querySelectorAll('.student-dashboard-nav button');
    navButtons.forEach(btn=>{btn.disabled=false;btn.classList.add('bmt-preview-safe');});
    const search=document.getElementById('contentSearch');
    if(search) search.disabled=false;
    if(typeof setupContentSearch==='function') setupContentSearch();
    ...
    const mutationPatterns=/logout|send|submit|save|delete|remove|payment|pay|enroll|join|qna|record|upload|translate|solve|create|select|change|enable push|mark all|bookmark/i;
        ...
        messages.forEach(item => {
            ...
            container.innerHTML += `
                <div class="chat-message" id="msg_${item.id}" style="${messageStyle} padding:10px; margin-bottom:8px; border-radius:var(--radius-md);">
                    ...
                    ${mediaHtml}
                    ${chat.mediaType === 'audio' && chat.durationSeconds ? `<div class="subtitle" style="margin-top:3px;">🎤 ${Math.round(Number(chat.durationSeconds))}s voice message</div>` : ''}
                    <div style="margin-top:6px; display:flex; gap:5px; flex-wrap:wrap;">
                        ...
                        <button type="button" class="btn btn-neutral" style="padding:3px 7px;font-size:11px;" data-chat-react="${item.id}:laugh">😂 ${(chat.reactions||{}).laugh||0}</button>
                        <button type="button" class="btn btn-neutral" style="padding:3px 7px;font-size:11px;" data-chat-react="${item.id}:wow">😮 ${(chat.reactions||{}).wow||0}</button>
...
async function loadStudentDevelopment(){
 ...
 try{
  ...
  box.innerHTML=catalog.map(c=>`<div class="card" style="margin-bottom:10px"><h4 style="margin:0 0 8px">${developmentEsc(c.title)}</h4>${(c.lessons||[]).map(l=>{const done=(state.completedLessons||[]).includes(l.id);return `<details style="border-top:1px solid var(--border-color);padding:8px 0"><summary style="cursor:pointer"><strong>${done?'✓ ':''}${developmentEsc(l.title)}</strong><span class="badge ${done?'badge-free':'badge-pending'}" style="margin-left:8px">${done?'Completed':'Lesson'}</span></summary><div style="margin-top:8px;display:grid;gap:7px"><div>🎥 <strong>Watch:</strong> ${developmentEsc(l.watch)}</div><div>📖 <strong>Read:</strong> ${developmentEsc(l.read)}</div><div>💭 <strong>Think:</strong> ${developmentEsc(l.think)}</div><div>📝 <strong>Practice:</strong> ${developmentEsc(l.practice)}</div><div>❓ <strong>Quiz:</strong> ${developmentEsc((l.quiz||[]).join(' • '))}</div><div>🏆 <strong>Achievement:</strong> ${developmentEsc(l.badge||'Growth Badge')}</div>${done?'':'<button class="btn btn-primary" type="button" data-dev-complete="'+developmentEsc(l.id)+'">Mark Lesson Complete</button>'}</div></details>`}).join('')}</div>`).join('');

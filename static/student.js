        ...
        if (booksContainer) {
            ...
            if (bookSnap.empty) {
                ...
                bookSnap.forEach(docSnap => {
                    ...
                    const coverUrl = String(data.coverUrl || data.thumbnailUrl || data.imageUrl || '').trim();
                    ...
                    booksContainer.innerHTML += `<article class="library-card">
                        ...
                        <div class="library-card-body">
                            ...
                            <div class="library-card-actions">
                                ...
                                <button class="library-star-btn" type="button" data-bookmark-id="${docSnap.id}" data-bookmark-title="${safeTitle}" data-bookmark-type="book" data-bookmark-url="${String(previewUrl).replace(/"/g,'&quot;')}" data-bookmark-storage-path="${isGcs ? String(data.storagePath || data.fileId || '').replace(/"/g,'&quot;') : ''}" data-bookmark-class="${String(selectedClass).replace(/"/g,'&quot;')}" aria-label="Save book">🔖</button>
                            </div>
                        </div>
                    </article>`;
                });

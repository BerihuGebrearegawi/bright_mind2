...
def phone_pin_login():
    ...
    try:
        ...
        secret_snap = db.collection('authSecrets').document(user.uid).get()
    ...
    try:
        ...
        payload = {
            ...
            "customization": {
                ...
                "description": f"BMT {plan_name} premium subscription",
            },
            "meta": {
                "payment_id": payment_id,
                "uid": uid,
                "plan": plan_name,
                "payment_reason": "Bright Mind Tutor premium subscription",
            },
        }
        if email:
            payload["email"] = email
